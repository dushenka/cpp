...
short mainMenuChoise, settingsChoise, gridChoise = 1, firstTurnChoise = 1, gameModeChoise, playerXChoise, playerOChoise, turnCPU, fieldOverflowStatus = 0;
...
void startMenu()
{
	...
	cin >> gameModeChoise;
	while (gameModeChoise < 1 || gameModeChoise > 2)
	{
